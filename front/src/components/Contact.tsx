    ...
    return (
        <section id="contact" className="py-16 md:py-24 px-6 md:px-16 max-w-[1000px] mx-auto border-t border-border">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6 fade-in">
                <a href="https://github.com/Brenotcs" target="_blank" rel="noreferrer" className="flex items-center gap-5 p-5 bg-card border border-border rounded-xl no-underline text-text transition-all duration-250 hover:border-accent hover:-translate-y-1 hover:shadow-[0_4px_20px_var(--color-glow)] group">
                ...
                <a href="https://linkedin.com/in/brenotcsouza" target="_blank" rel="noreferrer" className="flex items-center gap-5 p-5 bg-card border border-border rounded-xl no-underline text-text transition-all duration-250 hover:border-accent hover:-translate-y-1 hover:shadow-[0_4px_20px_var(--color-glow)] group">
                    <div className="w-[50px] h-[50px] bg-bg3 rounded-[12px] flex items-center justify-center text-[1.4rem] shrink-0 transition-colors duration-200 group-hover:bg-accent group-hover:text-white">
                ...
                <a href="https://wa.me/5571982964856?text=Ol%C3%A1%2C%20Breno!%20Vim%20pelo%20seu%20portf%C3%B3lio." target="_blank" rel="noreferrer" className="flex items-center gap-5 p-5 bg-card border border-border rounded-xl no-underline text-text transition-all duration-250 hover:border-accent hover:-translate-y-1 hover:shadow-[0_4px_20px_var(--color-glow)] group">
                    <div className="w-[50px] h-[50px] bg-bg3 rounded-[12px] flex items-center justify-center text-[1.4rem] shrink-0 transition-colors duration-200 group-hover:bg-accent group-hover:text-white">
                    ...
                    <div>
                        <div className="font-mono text-[0.72rem] text-text3 uppercase tracking-[0.1em] mb-1">WhatsApp</div>
